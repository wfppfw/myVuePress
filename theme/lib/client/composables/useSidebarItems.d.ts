...
import type { GungnirThemeData, GungnirThemeNormalPageFrontmatter, ResolvedSidebarItem, SidebarConfigArray, SidebarConfigObject } from "../../shared";
 ...
 */
export declare const resolveSidebarItems: (frontmatter: PageFrontmatter<GungnirThemeNormalPageFrontmatter>, themeLocale: GungnirThemeData) => ResolvedSidebarItem[];
/**
