<template>
  ...
  >
    <span ref="navbarBrand">
      ...
      <!-- <div class="animate__animated animate__heartBeat animate__infinite" style="color:brown"><i>s</i></div> -->
      <RouterLink :to="navbarBrandLink">
        <span class="site-name animate__animated animate__rubberBand">
          <!-- 修改左上角BrandTitle -->
          {{ navbarBrandTitle }}
