...
exports.getContainerPlugin = exports.resolveContainerPluginOptionsForLink = exports.resolveContainerPluginOptions = void 0;
 ...
 * For link card
 */
const resolveContainerPluginOptionsForLink = (options) => ({
    type: "link",
    before: (dsl) => {
        let context = dsl;
...
exports.resolveContainerPluginOptionsForLink = resolveContainerPluginOptionsForLink;
const getContainerPlugin = (localeOptions, options) => [
    options?.info !== false
        ? (0, plugin_container_1.containerPlugin)((0, exports.resolveContainerPluginOptions)(localeOptions, "info"))
        : [],
    options?.tip !== false
        ? (0, plugin_container_1.containerPlugin)((0, exports.resolveContainerPluginOptions)(localeOptions, "tip"))
        : [],
    options?.warning !== false
        ? (0, plugin_container_1.containerPlugin)((0, exports.resolveContainerPluginOptions)(localeOptions, "warning"))
        : [],
    options?.danger !== false
        ? (0, plugin_container_1.containerPlugin)((0, exports.resolveContainerPluginOptions)(localeOptions, "danger"))
        : [],
    ...
    options?.codeGroupItem !== false
        ...
        : [],
    options?.danger !== false
        ? (0, plugin_container_1.containerPlugin)((0, exports.resolveContainerPluginOptionsForLink)(options?.link))
        : []
];
exports.getContainerPlugin = getContainerPlugin;
